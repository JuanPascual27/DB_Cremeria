...
public class Proveedores extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(res == JOptionPane.YES_OPTION) {
            ...
            if (band != 1)
                JOptionPane.showMessageDialog(null, "Proveedor NO eliminado, Revise por favor");
            else {
                JOptionPane.showMessageDialog(null, "Proveedor Elimiando Exitosamente ");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        String idProveedor, nomProveedor, sql;
        if(metodo == 1){
            idProveedor = jTextField1.getText();
            nomProveedor = jTextField2.getText();
            sql = "insert into Proveedores values('" + idProveedor + "','" + nomProveedor + "')";
            int band = m.agregar(sql);
            if (band != 1)
                JOptionPane.showMessageDialog(null, "Proveedor NO registrado, Revise por favor");
            else {
            ...
            idProveedor = jTextField1.getText();
            nomProveedor = jTextField2.getText();
            sql = "update Proveedores set NomProveedor='" + nomProveedor + "' where IdProveedor='" + idProveedor + "'";
            int band = m.modificar(sql);
            if (band != 1)
                JOptionPane.showMessageDialog(null, "Proveedor NO modificado, Revise por favor");
            else {
